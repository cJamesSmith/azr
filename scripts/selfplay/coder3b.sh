...
python -m absolute_zero_reasoner.main_azr_ppo \
    ...
    actor_rollout_ref.model.path=$HOME/hfmodels/Qwen2.5-7B \
    ...
    azr.seed_dataset=/home/aiops/chenxw/CURE/data/CodeContests_train.json \
    ...
    +azr.sample.k_code=16 \
    +azr.sample.k_case=16 \
    +azr.sample.max_ground_truth_test=8 \
